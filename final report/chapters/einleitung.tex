...
usage of hand--crafted features. These systems are unfortunately not easily applicable
...
it with a deep reinforcement learning approach enables us learn more in the fields of reinforcement as well as deep learning.
...
In other words if no field with a min is adjacent to the chosen one, the chosen one has the digit $0$. 
...
This means if the player is sure that a filed contains a mine he can flag it to mark that that filed contains a mine. 
