...
\newcommand{\email}{merve.bayirli@uni-ulm.de, julian.heyna@uni-ulm.de, payam.ebadi-farkoosh@uni-ulm.de}
\newcommand{\titel}{Playing Minesweeper with
Reinforcement Learning in Neural Networks}
\newcommand{\jahr}{2017}
\newcommand{\matnr}{790102, 807811, 1009609}
